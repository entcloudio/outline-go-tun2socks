...
func NewOutlineTunnel(host string, port int, password, cipher string, isUDPEnabled bool, endpoint stack.LinkEndpoint) (OutlineTunnel, error) {
	...
	t.tunnel, err = MakeTunnel(endpoint, tcp, udp)
	if err != nil {
		return nil, err
	}
	return t, nil
